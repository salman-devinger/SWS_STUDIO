              ...
              if(mysqli_stmt_num_rows($stmt) == 1){
                  ...
                  if(mysqli_stmt_fetch($stmt)){
                      if(password_verify($pass, $hashed_password)){
                          ...
                          if(!isset($_SESSION['url']) && $type==1){
                            $url = "./sws_pages/index.php"; // default page for
                            //$url = $_SESSION['url']; // holds url for last page visited.
                          }
                          else if(!isset($_SESSION['url']) && $type!=1){
                            $url = "./sws_student/view_exercise.php"; // default page for
                            //$url = "./sws_pages/index.php"; // default page for
                          }
                          else if(isset($_SESSION['url']) && $type==1){
                            $url = $_SESSION['url']; // holds url for last page visited.
