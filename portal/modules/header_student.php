            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../sws_pages/logout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../sws_pages/index.php"><i class="fa fa-circle-o"></i> Student</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../sws_pages/index.php"><i class="fa fa-circle-o"></i> Upload</a></li>
            <li><a href="../sws_pages/index.php"><i class="fa fa-circle-o"></i> View</a></li>
            <li><a href="../sws_pages/index.php"><i class="fa fa-circle-o"></i> Edit</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
