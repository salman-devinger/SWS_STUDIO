        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>Demo Students</b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body" style="overflow-x:auto;">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $db_fld["EXPECTED_JOINING"];?></td>
                  <td><a href="admission.php?sno=<?php echo $db_fld["SNO"];?>" >Admission</a></td>
                </tr>
              <?php }
