...
if(isset($_REQUEST['sno']))
{
  ...
  $sql = 'CALL ATT_UI_GET_DEMO_DETAIL_BY_SNO('.$_REQUEST['sno'].')';
...
if(!empty($_POST['days'])) {
 ...
 $SQL="INSERT INTO tmp_student(name,fathername,fatheroccupation,mothername,gender,dob,mobile,email,adress,mobile_wsp,course,package,joining,reference) VALUES('$_POST[sname]','$_POST[fname]','$_POST[foccup]','$_POST[mname]','$_POST[gender]','$_POST[dob]','$_POST[phone]','$_POST[email]','$_POST[adress]','$_POST[phonewsp]','$_POST[course]','$_POST[package]','$_POST[joining]','$ref')";
  ...
  $SQL="CALL ATT_INSERT_STUDENT_DATA('$_POST[id]','$_POST[gender]','$_POST[sname]','$_POST[fname]','$_POST[occup]',
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group" >
                  ...
                  <input type="text" class="form-control" id="id_mname" name="mname" placeholder="Enter Mother's Name">
                </div>
                <div class="form-group" >
                  <label>Email</label>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group" >
                  ...
                  <input type="text" class="form-control" id="tname" name="tname" placeholder="Enter Teacher's Name">
                </div>
                <div class="form-group">
                  <label>Days</label>
